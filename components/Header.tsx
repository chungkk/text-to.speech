          ...
          <div className="flex items-center gap-4">
            ...
            <nav className="flex items-center gap-2">
              ...
              >
                ...
                <span className="hidden sm:inline">Longleng</span>
              </Link>
            </nav>

            {/* Language Dropdown */}
            <div className="relative group">
              <button className="flex items-center gap-2 px-3 py-2 sm:px-4 bg-white/10 hover:bg-white/20 text-white rounded-lg transition-all backdrop-blur-sm border border-white/30 hover:border-white/50 shadow-sm font-semibold">
            ...
            <Link
              href="/admin"
              className="flex items-center gap-2 px-3 py-2 sm:px-4 bg-white text-blue-600 rounded-lg hover:bg-blue-50 transition-all font-semibold shadow-sm hover:shadow-md"
            >
